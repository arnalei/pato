...
GO
PRINT N'Creating Table [dbo].[AJJK_table]...';


GO
CREATE TABLE [dbo].[AJJK_table] (
    [AJJK_Id]          NVARCHAR (50) NOT NULL,
    ...
    [AJJK_EDIT_ID]     INT           IDENTITY (1, 1) NOT NULL,
    PRIMARY KEY CLUSTERED ([AJJK_Id] ASC)
);


GO
PRINT N'Creating Procedure [dbo].[AJJK_add]...';
...
GO
PRINT N'Creating Procedure [dbo].[AJJK_del]...';
...
GO
PRINT N'Creating Procedure [dbo].[AJJK_dis]...';
...
GO
PRINT N'Creating Procedure [dbo].[AJJK_sea]...';
...
GO
PRINT N'Creating Procedure [dbo].[AJJK_upd]...';
